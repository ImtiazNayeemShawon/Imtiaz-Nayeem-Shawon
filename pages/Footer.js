    ...
    <div>
      <div className="mt-60 mx-40 max-sm:mx-4 max-sm:mt-20">
        ...
        <div>
          ...
          <button className="text-[#9C9C9C] px-20 py-3 bg-[#1A1A1A] border-[#2f2e2e] border rounded-sm flex items-center gap-2 hover:shadow-2xl shadow-[#8D8D8D] duration-300 m-auto mt-10">
            Get in touch{" "}
            <svg
