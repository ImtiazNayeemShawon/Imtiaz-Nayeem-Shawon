    ...
    <footer className="p-4 bg-white sm:p-6 dark:bg-gray-900 mt-96">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          ...
          <div>
            ...
            <ul className="text-gray-600 dark:text-gray-400">
              <li className="mb-4">
                <a
                  href="https://github.com/ImtiazNayeemShawon" target='blank'
              ...
              <li>
                <a
                  href="https://www.showwcase.com/imtiaznayeemshawon" target='blank'
                  className="hover:underline"
                >
                  Showwcase
                </a>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          <a
            href="https://www.facebook.com/imtinayeem/" target='blank'
          ...
          <a
            href="https://www.instagram.com/imtiaz_nayim/" target='blank'
            className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
          >
            <svg
              className="w-5 h-5"
          ...
          <a
            href="https://twitter.com/Imtiaz_Nayim" target='blank'
            className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
          >
            <svg
              className="w-5 h-5"
