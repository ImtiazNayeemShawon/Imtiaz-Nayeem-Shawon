  ...
  return (
    <div className="mx-60 mt-40 max-sm:mx-5 max-sm:mt-20">
      <div className="">
        ...
        <p className="text-center font-semibold mt-5 normal-case text-lg max-sm:text-sm max-sm:font-thin">I have extensive experience as a web developer, having worked with numerous organizations and gained valuable insights.</p>
          ...
          {Job.map((item) =>  (
            <div  className="flex">
              ...
              <div className="w-40 bg-green-300 rounded-xl h-1 mb-6"></div>
                ...
                <h2 className="text-justify mt-3 normal-case max-sm:hidden">{item.body}</h2>
              </div>
            </div>
          ))}
        </div>
