          ...
          <div className="steps max-md:p-3 border border-[#252525] p-10 rounded-2xl shadow-lg flex justify-between gap-10 items-start max-md:flex-wrap max-md:flex-col-reverse">
            ...
            <div className="flex flex-col gap-5">
              ...
              <article className="text-[#f5f1f1] font-light w-full ">
                ...
                approach, you can update or add features independently,
                minimizing disruptions. Containerization with tools like Docker
                ensures consistent environments and makes it easy to scale
                services horizontally.
                <br />
                <br />
                Opt for cloud-based databases from providers like AWS, Google
                Cloud, or Azure. These services offer automatic scaling,
                backups, and maintenance, reducing the operational workload.
                Implement a multi-tiered storage strategy: use high-performance
                storage for frequently accessed data and cost-effective options
                for archival.
                <br />
                <br />
                ...
                database costs, utilize the pay-as-you-go model to scale
                resources according to demand, avoiding over-provisioning.
                <br />
                <br />
          ...
          <div className="steps max-md:p-3 border border-[#252525] p-10 rounded-2xl shadow-lg flex justify-between gap-10 items-start max-md:flex-wrap max-md:flex-col-reverse">
            ...
            <div className="flex flex-col gap-5">
              ...
              <article className="text-[#f5f1f1] font-light w-full ">
                ...
                ready, I sometimes start with hand-drawn diagrams. Once the
                design is approved or provided by the client, I translate it
                ...
                approach helps maintain a consistent state across the
                application, making it easier to handle complex state
                interactions.
                <br />
                <br />
                API requests are handled server-side, where I set up endpoints
                to interact with the backend. Data fetching and caching
                mechanisms are implemented to ensure that data is retrieved
                efficiently and stored temporarily for quick access. This
                reduces server load and improves the user experience by
                delivering faster response times. Based on user requests, the
                cached data is displayed, ensuring that the application remains
          ...
          <div className="steps max-md:p-3 border border-[#252525] p-10 rounded-2xl shadow-lg flex justify-between gap-10 items-start max-md:flex-wrap max-md:flex-col-reverse">
            ...
            <div className="flex flex-col gap-5">
              ...
              <article className="text-[#f5f1f1] font-light w-full ">
                ...
                Mongoose as the ORM. For authentication, I implement JWT (JSON
                Web Tokens), Passport.js, sessions, and cookies to ensure secure
                and efficient user authentication processes. Passwords are
                hashed before being saved into the database to enhance security.
                <br />
                <br />
                ...
                storage solutions like Cloudinary for media assets and AWS S3
                for scalable object storage. This approach ensures that the
                backend is robust, secure, and adaptable to various project
                needs.
                <br />
