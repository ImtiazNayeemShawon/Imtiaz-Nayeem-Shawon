  ...
  return (
    <div className="mx-[10%] max-md:mx-[4%]">
      ...
      <div className="flex flex-col gap-10 l">
        {/* step 1 */}
        <div className="steps max-md:p-3 border border-[#252525] p-10 rounded-2xl shadow-lg flex justify-between gap-10 items-start max-md:flex-wrap max-md:flex-col-reverse min-h-[600px]">
          {/* left side  */}
